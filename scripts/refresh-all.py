...
STATE_SOURCES = {
    ...
    "az": {"type": "api", "fetcher": "api_states", "func": "fetch_az"},
    ...
    "il": {"type": "api", "fetcher": "api_states", "func": "fetch_il"},
    "ks": {"type": "api", "fetcher": "api_states", "func": "fetch_ks"},
    "ky": {"type": "api", "fetcher": "api_states", "func": "fetch_ky"},
    "la": {"type": "511", "fetcher": "platform_511"},
    "ma": {"type": "api", "fetcher": "api_states", "func": "fetch_ma"},
    "md": {"type": "local", "note": "No known public API - captured from chart.maryland.gov"},
    "mn": {"type": "api", "fetcher": "api_states", "func": "fetch_mn"},
    "mi": {"type": "api", "fetcher": "api_states", "func": "fetch_mi"},
    "mt": {"type": "api", "fetcher": "api_states", "func": "fetch_mt"},
    ...
    "sd": {"type": "api", "fetcher": "api_states", "func": "fetch_sd"},
